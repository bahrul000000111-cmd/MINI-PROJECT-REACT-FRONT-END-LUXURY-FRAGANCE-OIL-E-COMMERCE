      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-24 pb-16">
        <div className="max-w-xl">
          ...
          <h1 className="text-5xl md:text-6xl font-serif text-white leading-tight mb-4">
            ...
            <span className="text-[#C9A96E] italic">Luxury Hotel.</span>
          </h1>

          {/* Subheadline */}
          <p className="text-white/70 text-base mb-6 leading-relaxed max-w-md">
            Premium cold-air diffusers paired with our best-selling fragrance oils.
            No Heat, No Water, just clean, consistent scenting.
          </p>

          {/* Feature List */}
          <ul className="flex flex-col gap-2 mb-8">
            {[
              "Enjoy a luxury Hotel-level atmosphere at home.",
              "Safe for kids & pets.",
              "Easy Fragrance refills, zero stress.",
            ].map((item) => (
